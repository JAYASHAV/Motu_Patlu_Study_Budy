  ...
  return (
    <nav className='flex justify-between items-center px-4 py-2'>
      ...
      <ul className='flex gap-2'>
        ...
        {/* <Link className={`px-2 items-center flex w-fit text-sm ${ pathname=='/cart'? "font-medium border rounded-full border-white text-white" : "text-gray-200"}`} href="/cart"><li>Cart</li></Link> */}
      </ul>
